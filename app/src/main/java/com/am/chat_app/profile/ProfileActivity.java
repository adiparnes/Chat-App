package com.am.chat_app.profile;
...
import com.am.chat_app.login.LoginActivity;
import com.am.chat_app.password.ChangePasswordActivity;
import com.am.chat_app.signup.SignupActivity;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void removePhoto(){
        ...
        UserProfileChangeRequest request = new UserProfileChangeRequest.Builder()
                .setDisplayName(etName.getText().toString().trim()).setPhotoUri(null).build();
    ...
    private void updateNameAndPhoto(){
        ...
        //the file name when it will be upload to the server
        String strFileName = firebaseUser.getUid() + ".jpg";

        //fileStorage is the root folder
                ...
                if(task.isSuccessful())
                {
                    fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            serverFileUri = uri;
                            UserProfileChangeRequest request = new UserProfileChangeRequest.Builder()
                                    .setDisplayName(etName.getText().toString().trim()).setPhotoUri(serverFileUri).build();
                            firebaseUser.updateProfile(request).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task)
                                {
