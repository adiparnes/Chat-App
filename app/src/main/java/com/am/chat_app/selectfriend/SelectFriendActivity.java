package com.am.chat_app.selectfriend;
...
import com.am.chat_app.common.Extras;
                    ...
                    databaseReferenceUsers.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onCancelled(@NonNull DatabaseError databaseError) {
                            Toast.makeText(SelectFriendActivity.this,
                                    getString(R.string.failed_to_fetch_friends_list,databaseError.getMessage()), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
