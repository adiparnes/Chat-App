...
import com.am.chat_app.selectfriend.SelectFriendActivity;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MessageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MessagesAdapter.MessageViewHolder holder, int position) {
        ...
        String [] spiltString = dateTime.split(" ");
        String  messageTime = spiltString[1];
        ...
        if(fromUserId.equals(currentUserId))
        {
            ...
            Glide.with(context).load(message.getMessage()).placeholder(R.drawable.ic_image).into(holder.ivSent);
        }
        else
        {
            if(message.getMessageType().equals(Constants.MESSAGE_TYPE_TEXT))
            ...
            Glide.with(context).load(message.getMessage()).placeholder(R.drawable.ic_image).into(holder.ivReceived);
        }
        ...
        //long press to download/save/forward a message
    ...
    public ActionMode.Callback actionModeCallBack = new ActionMode.Callback() {
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            //background of selected message
