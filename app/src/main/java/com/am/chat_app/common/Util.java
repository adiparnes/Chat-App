package com.am.chat_app.common;
...
public class Util {
    ...
    //passing the title and the message of the notification
    //passing the userId - the person we want to send the notification
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.child(NodeNames.DEVICE_TOKEN).getValue()!=null)
                {
                    ...
                    try {
                        ...
                        String fcmApiUri = "https://fcm.googleapis.com/fcm/send";
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(fcmApiUri,notification,
